    ...
    <main style={{ background: BG, fontFamily: "system-ui, sans-serif", minHeight: "100vh" }}>
      ...
      <div style={{ background: PRIMARY, padding: "4rem 1.5rem 3rem", textAlign: "center" }}>
        ...
        <h1 style={{ fontFamily: "Georgia, serif", fontSize: "clamp(2rem, 5vw, 3rem)", color: "#F2EDE4", lineHeight: 1.15, maxWidth: 700, margin: "0 auto 1.25rem" }}>
          ...
          <span style={{ color: ACCENT }}>That is exactly why it pays so well.</span>
        </h1>
        <p style={{ fontSize: 16, color: "rgba(242,237,228,0.75)", lineHeight: 1.7, maxWidth: 540, margin: "0 auto 2rem" }}>
          No degree. No office. After disasters hit, trained adjusters can clear $5K to $10K in a single week. Take this quiz to see if this is the side hustle for you.
        </p>
        <Link href="/quiz" style={{ display: "inline-block", background: ACCENT, color: PRIMARY, padding: "14px 36px", borderRadius: 8, fontSize: 15, fontWeight: 700, textDecoration: "none" }}>
          Take the Free Quiz
        </Link>
      ...
      <div style={{ background: PRIMARY, padding: "3rem 1.5rem" }}>
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          ...
          <h2 style={{ fontFamily: "Georgia, serif", fontSize: "1.5rem", color: "#F2EDE4", textAlign: "center", marginBottom: "1.5rem", lineHeight: 1.3 }}>Three reasons this career keeps growing</h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 16 }}>
            {[
              { icon: "💰", title: "High income potential", body: "Experienced adjusters regularly clear $5K to $10K per week during peak CAT season." },
              { icon: "📍", title: "You control your time", body: "Between deployments you work when you want. No boss, no schedule, no office." },
              { icon: "⚡", title: "Fast to get started", body: "Most people can get licensed and deployment-ready in 4 to 8 weeks with the right guidance." },
            ].map((item, i) => (
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "3rem 1.5rem", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 15, color: "#666", lineHeight: 1.7, maxWidth: 460, margin: "0 auto 1.5rem" }}>
      ...
      <div style={{ borderTop: "1px solid #C8C0B4", padding: "1.5rem", textAlign: "center" }}>
        <div style={{ fontSize: 12, color: "#888" }}>The Feacher Formula &copy; 2026 | Presented by Larry Feacher II</div>
      </div>
